...
export type InputType =
  "douyin_url" | "video" | "subtitle" | "transcript" | "text";
export type RiskLevel = "low" | "medium" | "high";
export type ScriptProductionStatus =
  "draft" | "editing" | "review_ready" | "exported";
...
export interface ServerMediaTaskResult {
  source_url: string;
  title: string;
  author?: string | null;
  publish_time?: string | null;
...
export interface ServerMediaTask {
  id: string;
  source_url: string;
  ...
  stage_detail: string;
  progress: number;
  result?: ServerMediaTaskResult | null;
...
export type DraftInputType =
  "hotspot" | "outline" | "partial_script" | "script";
